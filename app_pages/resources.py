...
def run():
    ...
    if not filtered_categories:
        st.info(
            "No resources found. Try a different company name, "
            "category, or website domain."
        )
    else:
    ...
    st.info(
        "Missing a useful resource? Submit a user request with the "
        "website name, URL, and the category where it should appear."
    )
