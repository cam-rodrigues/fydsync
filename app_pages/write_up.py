...
def run():
    ...
    st.title("Investment Writeup Generator")
    st.markdown(
        """
        <div class="app-subtitle">
            Upload an MPI-style PDF fund scorecard. The app will extract the
            supporting fund data, generate standardized investment writeups,
            and prepare the completed analysis for PowerPoint export.
        </div>
        """,
        unsafe_allow_html=True,
    )
