...
LOADING_MESSAGES = [
    ...
    "Politely ignoring commas...",
    "Making spreadsheets less angry...",
    "Searching for the one cell that's formatted differently...",
